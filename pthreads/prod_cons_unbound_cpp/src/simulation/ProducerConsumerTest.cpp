...
// destructor de la clase encargado de liberar toda la memoria solicitada
...
//  funcion principal del programa, es la encargada de crear los hilos
// conectar las colas, asignarle a los hilos sus respectivos trabajos
// unir todos los hilos y liberar memoria
...
// funcion encargada de analizar si la cantidad de argumentos y dichos
// argumentos son los necesarios, de no serlo retorna EXIT_FAILURE
...
// funcion encargada de crear los hilos producer, dispacher, consumers
void ProducerConsumerTest::createThreads() {
  ...
  // creamos la cola del dispacher que esta conectada con el producer
...
// conectamos las colas con el dispacher
...
// iniciamos los hilos del productor, dispacher y consumidores
...
// funcion que libera todos los hilos creados
